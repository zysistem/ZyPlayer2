...
export const arr2hex = (data) => data.toHex();
...
export const arr2base = (bytes) => bytes.toBase64();
export const base2arr = (str) => Uint8Array.fromBase64(str);
...
export async function hash(data, format, algo = 'sha-1') {
