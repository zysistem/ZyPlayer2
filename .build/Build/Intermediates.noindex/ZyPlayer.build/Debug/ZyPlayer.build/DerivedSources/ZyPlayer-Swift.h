...
#ifndef ZYPLAYER_SWIFT_H
#define ZYPLAYER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ZyPlayer",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// Receives files opened from Finder or <code>open -a ZyPlayer <file></code>.
SWIFT_CLASS("_TtC8ZyPlayer11AppDelegate")
...
SWIFT_CLASS("_TtC8ZyPlayer9MPVGLView")
...
- (void)reshape;
- (nullable instancetype)initWithFrame:(NSRect)frameRect pixelFormat:(NSOpenGLPixelFormat * _Nullable)format SWIFT_UNAVAILABLE;
